...
const stateStyles = {
  default:   'border-zinc-700 bg-zinc-800/50 text-zinc-300 hover:border-zinc-500 hover:bg-zinc-800',
  selected:  'border-indigo-500 bg-indigo-600/20 text-white',
  correct:   'border-emerald-500 bg-emerald-600/20 text-emerald-300',
  incorrect: 'border-red-500 bg-red-600/20 text-red-300',
}
